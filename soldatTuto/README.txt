 ...
 by Nick "EnEsCe" Cooper. Please support EnEsCe by visiting his 
 website at http://enesce.com/ and consider donating!

 ---> Linux: Folder permissions... make the following folders writable with:
  a) chmod -R u+w ./logs/
  b) chmod -R u+w ./BattlEye/
 ...
 Startup parameters: (Advanced users!)
  ...
  ./soldatserver 
    ...
    -bl
     Usage: ./soldatserver -bl 4
            Limit the number of bots that can be added to the server.
    -k
